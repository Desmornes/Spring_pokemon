    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(authorize -> authorize
                        // Accès administrateur complet (CRUD, scraping, rebond)
                        .requestMatchers("/admin/**","/api/users/register","/api/scraping/**").hasRole("ADMIN") // Accès admin
                        ...
                        // Accès User
                        .requestMatchers("/user/**","/api/pokemon/**").hasRole("USER")
                        .requestMatchers(HttpMethod.POST, "/api/pokemon/**").hasRole("USER")
                        .requestMatchers(HttpMethod.PUT, "/api/pokemon/**").hasRole("USER")
                        // Tester (lecture uniquement)
                        .requestMatchers("/tester/**","/api/tester/**").hasRole("TESTER") // Accès tester
